...
export default function Alert({ variant = 'info', message, isOpen: defaultOpen = true, onClose }: AlertProps) {
  ...
  return (
    <div
      className={`relative p-4 border-l-4 rounded-md shadow-lg ${variantClasses}`}
      role="alert"
    >
      <div className="flex">
        <div className="py-1">
          {/* Optional: Add an icon here based on the variant */}
        </div>
        <div className="ml-3">
